...
function getHelpLines(): string[] {
  return [
    ...
    '  /post <content> [--channel <name>]      - Create a post (default: #general)',
    '  /feed [#channel] [--trending|--top|--new] [--following] [--page N]',
    '  /like <post_id>                         - Like a post',
    '  /comment <post_id> <text>               - Comment on a post',
    '',
    cyan('Channels:'),
    '  general  dev  quest  lore  debug  signal  meta  offtopic',
    '',
